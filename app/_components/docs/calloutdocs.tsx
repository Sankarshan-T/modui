                    ...
                    <table className="w-full text-sm text-left border-collapse">
                        ...
                        <tbody className="divide-y divide-slate-200">
                            <tr className="hover:bg-slate-50/50 transition-colors">
                                <td className="px-4 py-3 font-mono text-blue-600 font-medium">title</td>
                                <td className="px-4 py-3 text-slate-600">string</td>
                                <td className="px-4 py-3 text-slate-400">-</td>
                                <td className="px-4 py-3 text-slate-600">The title of the callout.</td>
                            </tr>
                            <tr className="hover:bg-slate-50/50 transition-colors">
                                <td className="px-4 py-3 font-mono text-blue-600 font-medium">color</td>
                                <td className="px-4 py-3 text-slate-600">"red" | "blue" | "green" | "yellow" </td>
                                <td className="px-4 py-3 text-slate-400">"blue"</td>
                                <td className="px-4 py-3 text-slate-600">The visual color of the callout.</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="ml-9">
                                <CodeBlock language="terminal" className="w-full">
                                    {`npx modui-uikit@latest add callout`}
                                </CodeBlock>
                            </div>
                        </div>
...
export default function Example() {
  return (
    <Callout title="Yellow callout" color="yellow">
      A simple yellow callout
    </Callout>
  )
}`}
                                </CodeBlock>
